              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    },child: Image.asset(Images.imgCircleBackWhite,width: 30,height: 30,)),
                  ],
                ),
              ),
            ),
                  ...
                  child: Consumer<LoginController>(builder: (context, loginProvider, _) {
                    return Column(
                      children: [
                        ...
                        Text(getTranslated("forgot_password2", context)!,
                        ...
                        Text(getTranslated("enter_your_email_below_to_reset_your_password", context)!,
                          textAlign: TextAlign.center,
                          style: const TextStyle(
