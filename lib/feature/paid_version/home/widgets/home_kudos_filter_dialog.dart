...
import '../../notification/widgets/home_belief_item.dart';
import '../domain/models/viewhomeresponse.dart';
import 'home_kudos_item.dart';

class HomeKudosFilterDialog extends StatelessWidget {
  final List<HomeBelief> kudosList;
                    ...
                    children: [
                      ...
                      ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          HomeBelief item = kudosList[index];
                          return HomeKudosItem(
                            item: item,
