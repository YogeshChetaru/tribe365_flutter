...
class KudosIndividualsDialog extends StatefulWidget {

  const KudosIndividualsDialog({super.key});

  @override
  State<KudosIndividualsDialog> createState() => _KudosIndividualsDialogState();
}

class _KudosIndividualsDialogState extends State<KudosIndividualsDialog> {
              ...
              InkWell(
                onTap: (){
                  ...
                  if (userSelected) {
                    ...
                    homeProvider.addKudosAwardMultiUser();
                  }
                  else {
