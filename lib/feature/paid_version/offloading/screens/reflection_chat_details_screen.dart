...
import '../widgets/reflection_chat_item.dart';

class ReflectionChatDetailsScreen extends StatefulWidget {
  final String reflectionId;

   const ReflectionChatDetailsScreen({super.key,required this.reflectionId});

  @override
  ReflectionChatDetailsScreenState createState() => ReflectionChatDetailsScreenState();
}

class ReflectionChatDetailsScreenState extends State<ReflectionChatDetailsScreen> {
  final GlobalKey<ScaffoldMessengerState> _scaffoldKey = GlobalKey();
  ProfileController profileController = Provider.of<ProfileController>(Get.context!, listen: false);
  OffloadingController offloading = Provider.of<OffloadingController>(Get.context!, listen: false);

  void apiLoad() {
    profileController.viewUserProfile().then((onValue) {
      offloading.updateData(profileController.userProfileData);
      offloading.viewReflectionChatMessages(int.parse(widget.reflectionId));
    });
  }
  ...
  getImageData(File? data) async {
    ...
    if (data != null) {
      ...
      offloading.reflectionSendChatMessages(
        "img",
        base64Image!,
        widget.reflectionId,
      );
          ...
          return Container(
            ...
            child: Column(
              children: [
                ...
                if(offloadingProvider.reflectionData!=null)
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        Utility.convertDataIntoddMMMyyyyhhmma(offloadingProvider.reflectionData!.initialMsgDate!),
                      ...
                      Text(
                        offloadingProvider.reflectionData!.initialMessage!,
                        style: TextStyle(fontSize: 12, fontWeight: FontWeight.w500, color: ColorResources.color333333, fontFamily: 'roboto'),
                      ),
                      if (offloadingProvider.reflectionData!.msgImageUrl != "")
                        Container(
                            alignment: Alignment.centerLeft,
                            margin: EdgeInsets.fromLTRB(0, 5, 0, 0),
                            child: Image.network(
                              offloadingProvider.reflectionData!.msgImageUrl!,
                              width: 60,
                              height: 60,
                              fit: BoxFit.fill,
                            )
                ...
                Expanded(
                    ...
                    child: SizedBox(
                      width: MediaQuery.sizeOf(context).width,
                      child: offloadingProvider.reflectionMessagesList == null || offloadingProvider.reflectionMessagesList!.isEmpty
                          ? Container(
                          ...
                          : Container(
                              ...
                              child: ListView.builder(
                                itemCount: offloadingProvider.reflectionMessagesList!.length,
                                shrinkWrap: true,
                                itemBuilder: (context, index) {
                                  return ReflectionChatItem(
                                    data: offloadingProvider.reflectionMessagesList![index],
                                  );
                                },
                              ),
                            ),
                  ...
                  offloadingProvider.isLoadingData == true
                    ...
                    onTap: () {
                      ...
                      if (msg.isEmpty) {
                        ...
                        offloadingProvider.reflectionSendChatMessages(
                          "msg",
                          msg,
                          widget.reflectionId,
                        );
