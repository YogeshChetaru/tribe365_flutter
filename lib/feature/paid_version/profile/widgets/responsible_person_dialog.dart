...
class ResponsiblePersonDialog extends StatefulWidget {
  final String name;
  const ResponsiblePersonDialog({super.key,required this.name});

  @override
  State<ResponsiblePersonDialog> createState() => _ResponsiblePersonDialogState();
}
...
class _ResponsiblePersonDialogState extends State<ResponsiblePersonDialog> {
  ...
  void initState() {
    ...
    profileController.searchController.addListener(profileController.filterUser);
  }
            ...
            children: [
              ...
              ListView.builder(
                ...
                itemBuilder: (context, parentIndex) {
                  final user = controller.filteredUserList![parentIndex];
                  return InkWell(onTap: (){
                    Navigator.pop(context);
                    controller.updateFilteredUserList(controller.filteredUserList![parentIndex]);
                  },
                      child: Column(
                        children: [
                          SizedBox(height: 10,),
