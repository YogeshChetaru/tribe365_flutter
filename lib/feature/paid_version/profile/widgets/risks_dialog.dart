...
class RisksDialog extends StatefulWidget {
  const RisksDialog({super.key});

  @override
  State<RisksDialog> createState() => _RisksDialogState();
}

class _RisksDialogState extends State<RisksDialog> {
  ...
  void initState() {
    ...
    profileController.searchController.addListener(profileController.filterTheme);
  }
            ...
            children: [
                ...
                children: [
                  Expanded(
                    ...
                    child: Text(
                      ...
                      getTranslated("select_risks", context)!,
                      style: TextStyle(
              ...
              ListView.builder(
                ...
                itemBuilder: (context, parentIndex) {
                  final user = controller.filteredThemeList![parentIndex];
                  return InkWell(
                      onTap: () {
                        Navigator.pop(context);
                        controller.updateFilteredThemeList(controller.filteredThemeList![parentIndex]);
                      },
                      child: Column(
                        children: [
                          SizedBox(
