class ConfigModel {
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    shipRocketApiToken = json['shiprocket_api_token'];
    ...
    deliveryPolicy = json['delivery_policy'] != null ? RefundPolicy.fromJson(json['delivery_policy']) : null;
    ...
    inhouseTemporaryClose = json['inhouse_temporary_close'] != null ? InhouseTemporaryClose.fromJson(json['inhouse_temporary_close']) : null;
    inhouseVacationAdd = json['inhouse_vacation_add'] != null ? InhouseVacationAdd.fromJson(json['inhouse_vacation_add']) : null;
...
class CurrencyList {
  ...
  CurrencyList({this.id, this.name, this.symbol, this.code, this.exchangeRate, this.createdAt, this.updatedAt});
...
class InhouseVacationAdd {
  ...
  InhouseVacationAdd({this.status, this.vacationStartDate, this.vacationEndDate, this.vacationNote});
...
class UserAppVersionControl {
  ...
  UserAppVersionControl({this.forAndroid});
