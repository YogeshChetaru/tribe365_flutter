...
class ValidateCheck{
  ...
  static String? validateEmptyText(String? value, String? message) {
    if (value == null || value.isEmpty) {
      return getTranslated(message, Get.context!)??getTranslated("this_field_is_required", Get.context!);
    }
    return null;
  }
  ...
  static String? validatePassword(String? value, String? message) {
    if (value == null || value.isEmpty) {
      ...
      return getTranslated(getTranslated('minimum_password_is_6_character', Get.context!), Get.context!);
    }
    return null;
  }
